...
export class DetailModalComponent implements OnInit{
    ...
    @ViewChild('editEchpModal') Echp: EditEchpModalComponent;
    home: HomeComponent;
  ...
  deleteEchipament(id: number){
    this.api.deleteEchipament(id).subscribe(()=>{
      this.home.getEchipamente();
      this.modal.hide();
